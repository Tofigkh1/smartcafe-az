...
console.log("orders",orders);
  ...
  const handlePrint = () => {
    const printContent = `
      <!-- Eyni HTML və CSS içeriği -->
    `;
  
    // Gizli bir div yaradın
    const hiddenDiv = document.createElement('div');
    hiddenDiv.style.cssText = 'position:fixed;left:-9999px;top:-9999px;';
    
    // Çap üçün HTML-i əlavə edin
    hiddenDiv.innerHTML = printContent;
    document.body.appendChild(hiddenDiv);
  
    // Çap əmri verin
    window.print();
  
    // Çapdan sonra elementi silin
    setTimeout(() => {
