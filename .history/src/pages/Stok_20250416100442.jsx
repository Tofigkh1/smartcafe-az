  ...
  useEffect(() => {
    ...
    formData.additionalPrices.forEach((priceObj, index) => {
      ...
      try {
        ...
        const responseRawMaterials = await axios.get(
          `${base_url}/stocks/${stockId}/raw-materials`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
        ...
        // Eğer raw materials ile ilgili işlem yapılacaksa buraya eklenebilir
        console.log("Raw Materials", responseRawMaterials.data);
        ...
        if (
          ...
          console.error("Hata Detayı:", error.response?.data); // Bu satırı ekle!
