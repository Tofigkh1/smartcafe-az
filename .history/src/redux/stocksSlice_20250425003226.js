...
import { getHeaders } from '../utils/auth'; // header fonksiyonunu dışarıdan alıyorsan

const base_url = 'https://your-api.com'; // bunu senin kullandığın adresle değiştir
...
export const { clearTableOrders } = tableOrdersSlice.actions;
